...
- Procedure 1 -
 ...
 1 - Plug the Nucleo/Discovery Board to the host PC using a mini/micro USB cable. If the ST-LINK driver is correctly installed, it will be recognized as an external memory device.
 2 - Drag and drop or copy the binary file into the device you see in Computer.
...
- Procedure 2 -
 ...
 2 - Plug the Nucleo/Discovery Board to the host PC using a mini/micro USB cable.
